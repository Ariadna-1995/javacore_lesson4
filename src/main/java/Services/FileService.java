...
public class FileService {
    ...
    public void fileWriterAssignment(List<Assignment> assignments) {
        String fileName = "assignments.txt";
        File file = new File(fileName);
        StringBuilder assignment = new StringBuilder();
        List<String> assignmentStringBuilder = new ArrayList<>();
        for (Assignment ass : assignments) {
            assignment.append(ass.getEmployee()).append(";")
                    .append(ass.getStatus()).append(";")
                    .append(ass.getTask()).append(";")
                    .append(ass.getId()).append(";");
            assignmentStringBuilder.add(assignment.toString());
        }
        fileWriter(assignmentStringBuilder, fileName, false);
    }
    ...
    public List<Employee> fileReaderEmployee() {
        ...
        for (String str : tempEmployee) {
            ...
            Employee employee = new Employee(lastname,firstName,birthDay,salary,department, skill, id);
